    ...
    <script>
      ...
      window.trendChart = new Chart(document.getElementById('trendChart'), {
        ...
        data: {
          ...
          datasets: [
            { label: 'PV', data: [${evm.PV*0.25}, ${evm.PV*0.5}, ${evm.PV*0.75}, ${evm.PV}, ${evm.PV}], borderColor: '#3b82f6', borderWidth: 3, fill: false },
            { label: 'EV', data: [${evm.EV*0.3}, ${evm.EV*0.5}, ${evm.EV*0.7}, ${evm.EV*0.85}, ${evm.EV}], borderColor: '#10b981', borderWidth: 3, fill: false }
          ]
        }
      });
